...
function Product1Order() {
    ...
    async function submit(e){
        ...
        await fetch('http://localhost:8000/user/product/starch',{
                    ...
                    <div className={style.form}>
                        ...
                        <form>
                            ...
                            <select  onChange={(e)=>setpurpose(e.target.value)} style={{height: "80%",width: "50%",marginLeft:"7vh"}}>
                                <option onChange={(e)=>setpurpose(e.target.value)} selected value="None">None</option>
                                <option onChange={(e)=>setpurpose(e.target.value)}  value="Reselling">Reselling</option>
                                <option onChange={(e)=>setpurpose(e.target.value)} value="RawMaterial">RawMaterial</option>
                            </select><br/>
