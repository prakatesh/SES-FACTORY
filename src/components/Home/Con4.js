...
export default function Con4() {
  return (
    ...
    <Col  data-aos="fade-right" data-aos-duration="1000" style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px",margin:"1rem",backgroundColor:"white"}} md={4}>
    <img className="d-block w-100" alt="suma" src={sag2} />
    </Col>
    <Col data-aos="fade-left" data-aos-duration="1000" style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px",margin:"1rem",backgroundColor:"white"}} md={4}>
    <h3>Sago Seeds</h3>
    ...
    <Col data-aos="fade-right" data-aos-duration="1500" style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px",margin:"1rem",backgroundColor:"white"}}  md={4}>
    <img className="d-block w-100" alt="suma" src={newsag} />
    </Col>
    <Col data-aos="fade-left" data-aos-duration="1500" style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px",margin:"1rem",backgroundColor:"white"}}  md={4}>
