...
export default function Con2() {
  return (
    <Row className='con2' style={{paddingLeft:"7%",marginTop:"4%",marginLeft:"10rem",marginRight:"10rem",backgroundColor:"white",boxShadow:"rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em",borderRadius:"0.9rem"}}>
    ...
    <Col data-aos="fade-left" data-aos-duration="1000" style={{paddingTop:"3vh",width:"50%"}} md={6}>
    <Video/>
    </Col>
    </Row>
  )
